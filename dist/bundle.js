...
/***/ "./node_modules/astroturf/css-loader.js!./src/components/product-card/index-styles.css":
/*!*********************************************************************************************!*\
  !*** ./node_modules/astroturf/css-loader.js!./src/components/product-card/index-styles.css ***!
  \*********************************************************************************************/
...
// module
exports.push([module.i, "\n  ._1MyREA3tBfSHs_S394ERMj {\n    flex-direction: column;\n    padding: 16px;\n\n    border-radius: 12px;\n    box-shadow: 0 5px 20px rgba(0, 0, 0, 0.2);\n  }\n\n  ._3f07OJnD7wyI7eQoRXNPVK {\n    margin-bottom: 4px;\n\n    color: #414554;\n    font-size: 17px;\n    line-height: 22px;\n    letter-spacing: -0.0241em;\n  }\n\n  .pjoNlEDZrYheBF5A1Cmq9 {\n    padding: 8px;\n    width: 100%;\n\n    color: #fff;\n    background: #17c486;\n\n    font-size: 1rem;\n    line-height: 24px;\n    font-weight: 500;\n    font-family: inherit;\n    white-space: nowrap;\n\n    border-radius: 100px;\n    border: 1px solid transparent;\n\n    transition: color 0.3s, background-color 0.3s;\n\n    cursor: pointer;\n    -webkit-appearance: none;\n    appearance: none;\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n  }\n", ""]);

// exports
exports.locals = {
	"card": "_1MyREA3tBfSHs_S394ERMj",
	"title": "_3f07OJnD7wyI7eQoRXNPVK",
	"addButton": "pjoNlEDZrYheBF5A1Cmq9"
};
...
/* WEBPACK VAR INJECTION */(function(global) {/*! Kefir.js v3.8.5
...
var products_list_1 = __importDefault(__webpack_require__(/*! components/products-list */ "./src/components/products-list/index.tsx"));
var Page = /** @class */ (function (_super) {
    ...
    Page.prototype.render = function () {
        return (react_1.default.createElement("main", null,
            react_1.default.createElement(products_list_1.default, null)));
    };
    return Page;
...
/***/ "./src/components/product-card/index-styles.css":
/*!******************************************************!*\
  !*** ./src/components/product-card/index-styles.css ***!
  \******************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/astroturf/css-loader.js!./index-styles.css */ "./node_modules/astroturf/css-loader.js!./src/components/product-card/index-styles.css");
...
/***/ "./src/components/products-list/index.tsx":
/*!************************************************!*\
  !*** ./src/components/products-list/index.tsx ***!
  \************************************************/
/*! no static exports found */
...
var ProductsList = /** @class */ (function (_super) {
    ...
    function ProductsList(props) {
        var _this = _super.call(this, props) || this;
        _this._setProducts = function (products) {
    ...
    ProductsList.prototype.componentDidMount = function () {
        this._gc.add(products_1.products.pProducts.observe(this._setProducts).unsubscribe);
    };
    ProductsList.prototype.componentWillUnmount = function () {
        this._gc.release();
    };
 ...
 * @template S
 */
var HistoryEmitter = /** @class */ (function (_super) {
    __extends(HistoryEmitter, _super);
    function HistoryEmitter(initial) {
        var _a, _b;
    ...
    HistoryEmitter.prototype._pushToHistory = function (newValue) {
        this._eFuture.set([]);
        this._ePast.patch(function (value) { return value.concat([newValue]); });
    };
    /**
    ...
    HistoryEmitter.prototype._slideHistory = function (from, to) {
        var _this = this;
        var futureValue = to.lastValue;
        var newLastValue = futureValue.pop();
        if (newLastValue) {
            to.set(futureValue);
            from.patch(function (value) { return value.concat([_this._lastValue]); });
            _super.prototype.set.call(this, newLastValue);
        }
    };
    return HistoryEmitter;
}(PersistentEmitter_1.PersistentEmitter));
exports.HistoryEmitter = HistoryEmitter;


/***/ }),

/***/ "./src/core/PersistentEmitter.ts":
/*!***************************************!*\
  !*** ./src/core/PersistentEmitter.ts ***!
  \***************************************/
/*! no static exports found */
 ...
 */
var PersistentEmitter = /** @class */ (function () {
    function PersistentEmitter(initial) {
        this._emitter = null;
        this._lastValue = initial;
    }
    Object.defineProperty(PersistentEmitter.prototype, "lastValue", {
        get: function () {
     ...
     */
    PersistentEmitter.prototype.set = function (value) {
        if (this._emitter) {
            this._lastValue = value;
            this._emitter.emit(value);
        }
        else
            throw Error('Попытка установки значения до привязки эмиттера');
    };
    /**
     ...
     * @memberof PersistentEmitter
     */
    PersistentEmitter.prototype.patch = function (fn) {
     ...
     * @memberof PersistentEmitter
     */
    PersistentEmitter.prototype.bind = function (emitter) {
     ...
     * @memberof PersistentEmitter
     */
    PersistentEmitter.prototype.unbind = function () {
        this._emitter = null;
    };
    return PersistentEmitter;
}());
exports.PersistentEmitter = PersistentEmitter;
...
var GarbageCollector = /** @class */ (function () {
    ...
    GarbageCollector.prototype.add = function (collector) {
        this._collectors.push(collector);
    };
    GarbageCollector.prototype.release = function () {
        this._collectors.map(function (c) { return c(); });
        this._collectors = [];
    };
...
exports.propertyWithHistory = propertyWithHistory;
function property(initial) {
    return createProperty(new PersistentEmitter_1.PersistentEmitter(initial));
}
exports.property = property;
function createProperty(ourEmitter) {
    var _stream = kefir_1.stream(function (emitter) { return ourEmitter.bind(emitter); });
...
var Products = /** @class */ (function (_super) {
    ...
    Products.prototype.load = function () {
        this.pProducts = utils_1.property(productsList)[0];
    };
    return Products;
}(store_1.Store));
exports.products = Products.getInstance();
///////////////////////////////////////////////////////
///////////////////////////////////////////////////////
///////////////////////////////////////////////////////
